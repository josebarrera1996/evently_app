...
If you're getting started and need assistance or face any bugs, join to an active Discord community with over 27k+ members. It's a place where people help each other out.
...
```bash
git clone https://github.com/josebarrera1996/evently_app
cd evently_app
```
